...
<head>
   ...
   <title>ShadowWilds-Comentarios</title>
...
?>
   ...
   <form action="" method="POST">
      ...
      <button type="submit" class="inline-btn" name="edit_comment">Editar Comentarios</button>
      <div class="inline-option-btn" onclick="window.location.href = 'user_comments.php';">Cancelar Edición</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <p class="comment-title">Tus comentarios en los Blogs</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> from : <span><?= $fetch_posts['title']; ?></span> <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>" >Ver Blog</a></div>
         <?php
            }
         ?>
         ...
         <form action="" method="POST">
            ...
            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('Borrar el comentario?');">Borrar comentario</button>
         </form>
      </div>
      <?php
            }
         }else{
            echo '<p class="empty">¡No tienes comentarios!</p>';
         }
      ?>
   </div>
