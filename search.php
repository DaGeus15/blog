...
<head>
   ...
   <title>ShadowWilds-Buscar</title>
...
<section class="posts-container">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         $select_posts = $conn->prepare("SELECT * FROM `posts` WHERE title LIKE '%{$search_box}%' OR category LIKE '%{$search_box}%' OR name LIKE '%{$search_box}%' AND status = ?");
